class FranceConnect::ParticulierController < ApplicationController
  ...
  before_action :set_user, only: [:new_resend_confirmation, :resend_confirmation]
  ...
  def confirm_email
    ...
    if user && user.confirmation_sent_at > 2.days.ago
      ...
      redirect_to france_connect_new_resend_confirmation_path, alert: "Lien de confirmation expiré. Un nouveau lien de confirmation a été envoyé."
    end
  end

  def new_resend_confirmation
