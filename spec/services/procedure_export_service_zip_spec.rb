describe ProcedureExportService do
  ...
  let(:export_template) { create(:export_template, groupe_instructeur: procedure.defaut_groupe_instructeur).tap { _1.pjs = _1.pjs.map { |pj| ExportItem.new(pj.to_h.merge('enabled' => true)) } } }
