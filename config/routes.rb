...
Rails.application.routes.draw do
  ...
  namespace :france_connect do
    ...
    get 'new_resend_confirmation', to: 'particulier#new_resend_confirmation', as: 'new_resend_confirmation'
    post 'resend_confirmation', to: 'particulier#resend_confirmation', as: 'resend_confirmation'
